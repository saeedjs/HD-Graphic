        ...
        >
          <Box sx={{ display: "flex", pt: "14px", justifyContent: "space-between" }}>
            <Box sx={{ display: "flex", pr: "15px" }}>
              <Box>
                ...
                >
                  <Typography
                    sx={{ fontSize: "12px", fontWeight: "bold", color: "#B79200", p: "5px" }}
                  >
                    {blog.category.title}
                  </Typography>
                </Box>
              ...
              <Box pr={"10px"}>
                ...
                >
                  <Typography sx={{ fontSize: "12px", fontWeight: "bold", color: "#232931" }}>
                    نویسنده
                  </Typography>
                </Box>
              </Box>
          ...
          <Box sx={{ pb: "15px", display: "flex", flexDirection: "column" }}>
            ...
            <Box sx={{ height: "52px", display: "flex", justifyContent: "center" }}>
              <Typography
                sx={{ fontSize: "14px", width: "316px", color: "#9A9A9A", overflow: "hidden" }}
              >
